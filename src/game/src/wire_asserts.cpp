...
static_assert(sizeof(CSCPlayerInfo) == 801, "CSCPlayerInfo wire size != 801 (12 hdr + 1 resp + 788 body)");
static_assert(offsetof(CSCPlayerInfo, m_nResponse)   == 12, "CSCPlayerInfo.m_nResponse offset");
static_assert(offsetof(CSCPlayerInfo, m_cPlayerInfo) == 13, "CSCPlayerInfo.m_cPlayerInfo offset (no pad before body)");
...
static_assert(sizeof(CSCGrowupCharacter) == 802, "CSCGrowupCharacter wire size != 802 (12 hdr + 2 + 788 body)");
